#ifndef CONJUNCTIONS_LAZY_SEARCH_RELAXED_SUBGOALS_LOOKAHEAD_BOUNDED_EXPANSIONS_H
#define CONJUNCTIONS_LAZY_SEARCH_RELAXED_SUBGOALS_LOOKAHEAD_BOUNDED_EXPANSIONS_H
...
class LazySearchRSLBoundedExpansions : public OnlineLearningSearchEngine {
protected:
	...
	static auto get_lookahead_bound(const AbstractTask &task, const std::string &bound) -> int;
...
public:
	explicit LazySearchRSLBoundedExpansions(const options::Options &opts);
	virtual ~LazySearchRSLBoundedExpansions() = default;
