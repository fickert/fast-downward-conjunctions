...
void LazySearchRelaxedSubgoalsLookahead::set_iterated_weights_options(const options::Options &opts) {
...
auto LazySearchRelaxedSubgoalsLookahead::has_another_phase() const -> bool {
...
void LazySearchRelaxedSubgoalsLookahead::restart_with_next_weight() {
...
void LazySearchRelaxedSubgoalsLookahead::update_eval_context(EvaluationContext &eval_context, const decltype(heuristic_cache)::mapped_type &cache_entry) {
...
auto LazySearchRelaxedSubgoalsLookahead::evaluate_if_neccessary(EvaluationContext &eval_context) -> int {
...
static options::Plugin<SearchEngine> _plugin("lazy_rsl", _parse);
static options::Plugin<SearchEngine> _plugin_greedy("lazy_greedy_rsl", _parse_greedy);
static options::Plugin<SearchEngine> _plugin_weighted_astar("lazy_wastar_rsl", _parse_weighted_astar);
static options::Plugin<SearchEngine> _plugin_iterated_weights("lazy_iterated_weights_rsl", _parse_iterated_weights);
}
