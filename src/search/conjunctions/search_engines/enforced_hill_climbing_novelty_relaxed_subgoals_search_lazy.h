#ifndef CONJUNCTIONS_ENFORCED_HILL_CLIMBING_NOVELTY_RELAXED_SUBGOALS_SEARCH__LAZY_H
#define CONJUNCTIONS_ENFORCED_HILL_CLIMBING_NOVELTY_RELAXED_SUBGOALS_SEARCH__LAZY_H
...
class EnforcedHillClimbingNoveltyRelaxedSubgoalsSearchLazy : public OnlineLearningSearchEngine {
public:
	explicit EnforcedHillClimbingNoveltyRelaxedSubgoalsSearchLazy(const options::Options &opts);
	~EnforcedHillClimbingNoveltyRelaxedSubgoalsSearchLazy() override;
...
private:
	...
	static auto create_open_list() -> open_list_t;
