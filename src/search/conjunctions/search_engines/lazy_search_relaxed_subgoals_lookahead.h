#ifndef CONJUNCTIONS_LAZY_SEARCH_RELAXED_SUBGOALS_LOOKAHEAD_H
#define CONJUNCTIONS_LAZY_SEARCH_RELAXED_SUBGOALS_LOOKAHEAD_H
...
class LazySearchRelaxedSubgoalsLookahead : public OnlineLearningSearchEngine {
protected:
